...
parser.add_argument("--image", default='custom_data/test_images/maxwell_3.resized.jpg', help="image for prediction")
...
'''
parser = argparse.ArgumentParser(add_help=False)
parser.add_argument("--image", default='custom_data/test_images/stop_sign_15.resized.jpg', help="image for prediction")
parser.add_argument("--config", default='custom_data/cfg/yolov3-tiny-custom.cfg', help="YOLO config path")
parser.add_argument("--weights", default='backup/yolov3-tiny-custom_500.weights', help="YOLO weights path")
parser.add_argument("--names", default='data/coco.names', help="class names path")
args = parser.parse_args()
'''
